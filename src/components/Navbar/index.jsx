...
export const Navbar = () => {
  ...
  return (
    <header
      className={`flex px-5 py-4 rounded-sm bg-gray-900 dark:bg-gray-800 text-slate-500 dark:text-gray-300`}
    >
      <div
        onClick={() => navigate("/")}
      ...
      <nav className="ml-auto text-slate-50 dark:text-gray-300 flex align-center gap-5">
        <div
          ...
          className={`w-8 h-8 text-center hover:bg-gray-700 dark:hover:bg-gray-700 hover:cursor-pointer rounded-md flex items-center justify-center ${
